...
{
    [TestClass]
    public class XmlDataNSI95Test
    {
        [TestMethod]
        public void BuildDataTable_CorrectXML_DataTable()
        {
            // Arrange.
            string bodyXML = System.IO.File.ReadAllText("TaskUnit\\NsiСommon\\ExportNsiItem\\ResultFromGis_NSI95.xml");


            // Act.
            XmlDataNSI95 xmlData = new XmlDataNSI95(bodyXML);
